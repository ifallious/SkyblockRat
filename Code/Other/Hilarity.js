...
register("step", () => {
  ...
  if (saymessage) {
    ...
    if (lettime == 0) {
      randomnumer = Math.floor(Math.random() * 1000)
      saymessage = true
    }
  }
}).setFps(1)